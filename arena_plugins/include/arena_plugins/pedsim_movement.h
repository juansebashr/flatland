 ...
 * @brief The movement of the pedsim agents is as well applied to the flatland
 * models. Furthermore a walking pattern is added
 *
 */
class PedsimMovement : public ModelPlugin {
 ...
 private:
  ...
  b2Body
      *safety_dist_b2body_danger_zone;  ///< Pointer to safety distance circle
  ...
  ros::Publisher
      agent_state_pub_;  ///< Publisher for agent state of  every pedsim agent
  ...
  bool toggle_leg_movement_;  ///< if true: legs are moving. if false: legs
                              ///< stand still
  ...
  /**
   * @brief Method is copy of model_body.cpp to be able to change radius
   * programatically ToDo: Find more elegeant solution!
   */
