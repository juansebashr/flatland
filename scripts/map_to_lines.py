...
def main():
    ...
    arg_parser = argparse.ArgumentParser(
        description="Generate line segment data file from ROS map server data"
    )
    ...
    if definition == "low":
        lsd = cv2.createLineSegmentDetector(
            cv2.LSD_REFINE_STD, 1.05, 1, 1, 22.5, 1, 0.8
        )
    elif definition == "med":
    ...
    for line in lines:
        line = line[0]
        output_lines_file.write(
            "%25.15f %25.15f %25.15f %25.15f\n"
